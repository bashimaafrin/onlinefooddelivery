...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2019 at 05:45 AM
...
('anshi', 'anshi', 'qwertyjk@sdfgh', '45652296385', 'wertfgyhrtgyu', '12345'),
...
(80, 'cake', 250, 'it is made of strawberry', 7, 'cake.jpg', 'DISABLE'),
(81, 'burger', 150, 'double cheese chicken burger', 7, 'burger.jpg', 'DISABLE'),
(82, 'burger', 250, 'double cheese chicken burger', 7, 'burger.jpg', 'DISABLE'),
(83, 'burger', 150, 'double cheese chicken burger', 7, 'images/burger.jpg', 'ENABLE');
...
('bashima', 'anshida', 'asdfg@erty', '785458596852', 'wsedfghedrfgtyui', '12345'),
('ckumar', 'Chandan Kumar', 'ckj40856@gmail.com', '9487810674', 'Pondicherry University, SRK HOSTEL ROOM NUMBER-59,', 'Ckumar123'),
...
(69, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-10-31', 'anshi', 3),
(70, 59, 'Meurig Fish', 60, 1, '2019-10-31', 'anshi', 2),
(71, 80, 'cake', 250, 1, '2019-10-31', 'anshi', 7),
(72, 59, 'Meurig Fish', 60, 1, '2019-11-14', 'anshi', 2),
(73, 63, 'Baahubali Thali', 75, 1, '2019-11-14', 'anshi', 3),
(74, 61, 'Happy Happy Choco Chip Shake', 80, 1, '2019-11-14', 'anshi', 1),
(75, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-14', 'anshi', 1),
(76, 82, 'burger', 250, 1, '2019-11-14', 'anshi', 7),
(77, 83, 'burger', 150, 1, '2019-11-14', 'anshi', 7),
(78, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-15', 'anshi', 1),
(79, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(80, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(81, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(82, 83, 'burger', 150, 1, '2019-11-15', 'anshi', 7),
(83, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(84, 83, 'burger', 150, 1, '2019-11-15', 'anshi', 7),
(85, 59, 'Meurig Fish', 60, 1, '2019-11-15', 'anshi', 2),
(86, 69, 'Coffee', 25, 1, '2019-11-15', 'anshi', 2),
(87, 69, 'Coffee', 25, 1, '2019-11-15', 'anshi', 2),
(88, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(89, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-15', 'anshi', 1),
(90, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(91, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-15', 'anshi', 3),
(92, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-15', 'anshi', 1),
(93, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-15', 'anshi', 1),
(94, 59, 'Meurig Fish', 60, 1, '2019-11-15', 'anshi', 2),
(95, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-15', 'anshi', 1),
(96, 58, 'Juicy Masala Paneer Kathi Roll', 40, 1, '2019-11-15', 'anshi', 1),
(97, 60, 'Chocolate Hazelnut Truffle', 99, 1, '2019-11-18', 'anshi', 3),
(98, 71, 'Samosa', 40, 1, '2019-11-18', 'anshi', 2),
(99, 71, 'Samosa', 40, 1, '2019-11-18', 'anshi', 2),
(100, 63, 'Baahubali Thali', 75, 3, '2019-11-18', 'anshi', 3),
(101, 60, 'Chocolate Hazelnut Truffle', 99, 7, '2019-11-18', 'anshi', 3),
(102, 83, 'burger', 150, 1, '2019-11-18', 'anshi', 7),
(103, 83, 'burger', 150, 1, '2019-11-20', 'anshi', 7);
...
(7, 'prax', 'esdfg@h.com', '345678', 'qwertydfgh', 'bashima');
...
INSERT INTO `user_order` (`username`, `food_name`, `price`, `quantity`) VALUES
('anshi', 'Samosa', '40', 1),
('anshi', 'Samosa', '40', 1),
('anshi', 'Samosa', '40', 1),
('anshi', 'Samosa', '40', 1),
('anshi', 'Samosa', '40', 1),
('anshi', 'Samosa', '40', 1),
('anshi', 'Baahubali Thali', '75', 3),
('anshi', 'Baahubali Thali', '75', 3),
('anshi', 'Chocolate Hazelnut Truffle', '99', 7),
('anshi', 'burger', '150', 1),
('', 'burger', '150', 1);
...
--
ALTER TABLE `orders`
  MODIFY `order_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
