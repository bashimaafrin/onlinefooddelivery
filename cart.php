            ...
            <li class="active" ><a href="index.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart
             (<?php
              ...
              ?>)
               ...
               <li><a href="history.php"><span class="glyphicon glyphicon-log-out"></span> History </a></li>
...
<td></td>
        ...
        <?php
        $usr_nme=$_SESSION['login_user2'];
        $fd_nme=$values["food_name"];
        $fd_qntity=$values["food_quantity"];
        $fd_price=$values["food_price"];
        $qry="insert into user_order values('$usr_nme','$fd_nme','$fd_price','$fd_qntity')";
